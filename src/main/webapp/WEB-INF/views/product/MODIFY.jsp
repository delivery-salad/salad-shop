    ...
    <section class="product-details spad">
        <div class="container">
            <div class="row">
				...
				<form action="<c:url value='/product//product/productModify' />" method="post" enctype="multipart/form-data" >
		...
		<input type="hidden" name="productNum"  value="${product.productNum}">
					...
					<table>
                           <tbody>
                                ...
                                <tr>
                                    <td>상품 개수</td>
                                    <td>	<input type="text" name="productCount" value="${product.productCount }">
                                    </td>
                                </tr>
                                <tr>
                                    <td>상품 부제목</td>
                                    <td><input type="text" name="productContent" value="${product.productContent }"> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>상품 썸네일</td>
                                    <td>
                                    <input type="text" readonly="readonly" id="file_nam" value="${product.productImgName}">
                                     <label for="file_url">업로드</label>
                                    <input class="form-control"  type="file" name="file_url" id="file_url"  value="${product.productImgName }" >
                                    	
                                    	<img  id="pre"  src="<c:url value='/product/productImgGet/fileName=${product.productImgName}'/> " >
                                    </td>
                                </tr>
                                <tr>
                                    <td>상품 상세 이미지</td>
                                    <td>
                                      <input type="text" readonly="readonly" id="file_nam2" value="${product.productContentImgName}">
                                      <label for="file_content">업로드</label>
                                    <input class="form-control"  type="file" name="file_content" id="file_content"   >
                                    	<img  id="pre_content" src="<c:url value='/product/productImgGet/fileName=${product.productContentImgName}' />">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
