  ...
  <div class="container cont" >
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        ...
        <form class="validation-form" id="joinForm" action="<c:url value='/user/registUser'/>" method="post" novalidate>
          <div class="row">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="basic-address" name="userBasicAddr" placeholder="서울특별시 강남구" required>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="detail-address" name="userDetailAddr" placeholder="상세주소를 입력해주세요.">
          </div>
          ...
          <div class="custom-control custom-checkbox">
            ...
            <textarea style="width: 100%; height: 300px; border: none; resize: none;">
제 1 장 총칙
...
(시행일) 본 약관은 2018년 8월 1일부터 시행됩니다. 개정된 약관의 적용일자 이전 이용자 또는 회원은 개정된 이용약관의 적용을 받습니다.
          ...
          <!-- 버튼 부분  -->
          <div class="regist-cancel-btn">
            <button class="btn btn-primary btn-lg btn-success regist-btn" type="button" id="joinBtn">가입 완료</button>
            <button class="btn btn-primary btn-lg btn-success cancel-btn" type="button" id="CancelBtn">취소</button>
